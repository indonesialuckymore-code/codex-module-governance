...
def main():
    ...
    for skill_name, stage in {"engineering-ledger-manager": "C03", "task-package-generator": "C04", "occupancy-conflict-checker": "C05", "independent-handover-validator": "C06"}.items():
    ...
    print("Plugin manifest and C02/C03/C04/C05/C06 Skill contract preflight passed.")
