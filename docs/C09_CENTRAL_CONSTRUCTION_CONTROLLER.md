...
现在 Codex 模块有且只有一个中央路由器。C00 `construction-outline-planner` 在独立规划窗口与 Boss 形成大纲，不经过中央、不写总账；大纲冻结后，C12 自然语言前台再把 Boss 的“新建项目”“登记候选任务”“生成下一任务包”“批准派发”“验收这个回传”“这个阻塞我不能裁定”或“窗口失联了”等业务话转换为标准请求，C09 查唯一工程总账并送到 C02–C11 中唯一正确的执行能力。
