...
稳定安装基线仍是 `0.13.0`。当前 `main` 新增待下版发布的 C00 通用施工大纲规划能力；既有 C01–C13 自然语言前台、唯一中央路由器、工程总账、任务包、占用、验收、裁定、恢复、任务调度、外部 Skill 登记与适配，以及私有 GitHub Marketplace 安装、升级和回退验收保持不变。
